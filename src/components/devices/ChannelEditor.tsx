...
export function ChannelEditor() {
  ...
  return (
    <div className="flex flex-col h-full bg-background overflow-hidden relative">
      {/* Header */}
      <div className="flex items-center justify-between px-3 py-1.5 border-b border-border bg-card/50 backdrop-blur-sm z-10 sticky top-0">
        <div className="flex flex-col">
          <h2 className="text-[10px] font-semibold tracking-tight text-foreground flex items-center">
        ...
        <div className="flex items-center space-x-3">
          {isConnected ? (
            <button
              ...
              className="flex items-center px-3 py-1 bg-destructive/10 text-destructive hover:bg-destructive/20 border border-destructive/20 rounded-md shadow-sm transition-all text-[10px] font-medium"
            >
            ...
            <button
              ...
              className="flex items-center px-3 py-1 bg-emerald-500/10 text-emerald-500 hover:bg-emerald-500/20 border border-emerald-500/20 rounded-md shadow-sm transition-all text-[10px] font-medium"
            >
          ...
          <button
            onClick={handleSave}
            className={`flex items-center px-3 py-1 rounded-md shadow-md transition-all text-[10px] font-medium ${
              isSaved
      ...
      {/* Telemetry Bar */}
      <div className="bg-[#111116] border-b border-border px-3 py-1 flex items-center justify-between text-[11px] font-mono text-zinc-400 select-none z-0 relative">
        ...
        <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-1 grid grid-cols-2 gap-1.5">
            <div className="space-y-2">
              <label className="text-[10px] font-medium text-muted-foreground">Channel Name</label>
              <input
                type="text"
                value={localChannel.name}
                onChange={(e) => setLocalChannel({ ...localChannel, name: e.target.value })}
                className="w-full bg-background border border-input rounded-md px-3 py-1 text-[10px] focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all"
              />
            </div>
          </div>
        </div>
        ...
        <div className="bg-card border border-border rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-1 grid grid-cols-2 gap-1.5">
              ...
              <>
                <div className="space-y-2">
                  ...
                  <input
                    ...
                    className="w-full bg-background border border-input rounded-md px-3 py-1 text-[10px] focus:outline-none focus:ring-1 focus:ring-primary focus:border-primary transition-all font-mono"
                    placeholder="127.0.0.1"
                  />
                </div>
                <div className="space-y-2">
                  <label className="text-[10px] font-medium text-muted-foreground">TCP Port</label>
                  <input
                    type="number"
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-medium text-muted-foreground">Response Timeout (ms)</label>
                  <input
                    type="number"
            ...
            {isSerial && (
              <>
                <div className="space-y-2">
                  <label className="text-[10px] font-medium text-muted-foreground">Baud Rate</label>
                  <select
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-medium text-muted-foreground">Data Bits</label>
                  <select
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-medium text-muted-foreground">Stop Bits</label>
                  <select
                ...
                <div className="space-y-2">
                  <label className="text-[10px] font-medium text-muted-foreground">Parity</label>
                  <select
            ...
            {!isTcp && !isSerial && (
              <div className="col-span-2 text-center py-8 text-muted-foreground italic text-[10px]">
